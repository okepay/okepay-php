 ...
 */
class Invoice extends \OkePay\Models\Base
{
     ...
     * can be found here: http://developers.okepay.info/docs/miscellaneous
     *
     * @param int $psp
     */
     ...
     * This name will only be shown to administrator of the OkePay site.
     *
     * @param string $name
     */
     ...
     * A list of available currencies you can find on http://developers.okepay.info/docs/miscellaneous
     *
    ...
    {
        return new \OkePay\Models\Response\Invoice();
    }
}
